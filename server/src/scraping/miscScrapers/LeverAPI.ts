...
const DEFAULT_LEVER_BOARDS = [
  ...
  // ── More YC / Startup companies ───────────────────────────────────────────
  'airtable', 'canva', 'deel', 'carta', 'lattice', 'rippling',
  'loom-video', 'notion-labs', 'linear-app', 'mercury-bank',
  'brex-hq', 'ramp-financial', 'pilot-com', 'runway-financial',
  'airbase-hq', 'mainstreet', 'rho-inc', 'found', 'lili-bank',
  'nearside', 'relay', 'novo', 'bluevine', 'kabbage',
  'justworks', 'rippling-hq', 'rippleworks', 'remote-hq',
  'oyster-hr', 'deal', 'remote-year', 'safeguard-global',
  'globalupside', 'globalization-partners', 'papaya-global',
  'immedis', 'activepayroll', 'sky-pay',
  // ── Security / Infra ──────────────────────────────────────────────────────
  'lacework', 'orca-security', 'wiz-io', 'ermetic', 'accurics',
  'aqua-security', 'sysdig', 'twistlock', 'stackrox', 'neuvector',
  'tigera', 'nirmata', 'opscruise', 'appsense',
  'illumio', 'guardicore', 'vectra-ai', 'darktrace', 'extrahop',
  'stamus-networks', 'corelight', 'gigamon', 'netscout',
  'expel', 'huntress', 'cybereason', 'sentinelone',
  'datto', 'kaseya', 'n-able', 'connectwise',
  'liongard', 'auvik', 'pulseway', 'action1',
  'itarian', 'syncro', 'repairshopr', 'atera',
  // ── Data & Analytics ──────────────────────────────────────────────────────
  'dbt-labs', 'airbyte', 'meltano', 'singer-io',
  'stitch-data', 'segment-io', 'rudderstack', 'hightouch-io',
  'census-data', 'grouparoo', 'omnata', 'y42',
  'transform', 'supergrain', 'metriql', 'atlan',
  'alation', 'selectstar', 'amundsen', 'marquez',
  'metaphor-data', 'datahub-project', 'openlineage',
  're-data', 'elementary-data', 'piperider',
  'soda-data', 'great-expectations', 'deequ',
  'datafold-io', 'recce', 'sqlfluff', 'dbt-osmosis',
  // ── Climate & Impact ──────────────────────────────────────────────────────
  'terrawatch', 'carbon-direct', 'planetly', 'ey-parthenon-climate',
  'rubicon-carbon', 'carbonplace', 'thallo', 'flowcarbon',
  'single-use-ain', '11th-hour-project', 'bezos-earth-fund',
  'heirloom-carbon', 'charm-industrial', 'graphyte', 'verdox',
  'origin-materials', '12-trees', 'carbfix', 'climeworks',
  'global-thermostat', 'carbon-engineering', 'octavia-carbon',
  'sustaera', 'noya', 'neto', 'eion', 'lithos-carbon',
  'travertine', 'ebb-carbon', 'planetary-technologies',
  'calcite', 'equatic', 'captura', 'co2-solutions',
  'mangrove-pmx', 'sea6energy', 'running-tide',
  'phykos', 'ocean-based-climate', 'agar',
  // ── Social Impact / Mission ───────────────────────────────────────────────
  'brightline-initiative', 'pathways-to-education',
  'college-possible', 'first-org', 'college-advising-corps',
  'national-college-attainment', 'saga-education',
  'the-knowledge-house', 'puente-project', 'i-mentor',
  'year-up', 'urban-teacher-center', 'teach-for-america',
  'city-year', 'americorps', 'peace-corps',
  'idealab', 'echoing-green', 'ashoka', 'skoll-foundation',
  'omidyar-network', 'schwab-social', 'draper-richards-kaplan',
  'rethink-education', 'owl-ventures', 'learn-capital',
  'reach-capital', 'impact-engine', 'zebras-unite',
  // ── Biotech / Life Sciences ───────────────────────────────────────────────
  'absci', 'arzeda', 'basecamp-research', 'deepmind-bio',
  'envision-genomics', 'era7', 'ge-healthcare', 'genomatica',
  'ginkgo-bioworks', 'grail-bio', 'guardant-health',
  'heliogen', 'inari-agriculture', 'indigo-ag', 'innova-food',
  'joyn-bio', 'khora', 'kymera-therapeutics', 'larimar',
  'light-bio', 'longeviti', 'lumen-bioscience',
  'mango-materials', 'meati-foods', 'menlo-microsystems',
  'metabolon', 'microbiome-labs', 'mirimus', 'modern-biosciences',
  'molecular-data', 'newleaf', 'notch-therapeutics',
  'ohana-biosciences', 'onconova', 'oricell', 'origin-agritech',
  'pattern-bioscience', 'pioneer-square-labs', 'praxis-bio',
  'precision-biosciences', 'prescient-design', 'project-apollo',
  'protomer-technologies', 'proteonics', 'proteovant',
  // ── Batch 4: Games, Space, Deep Tech, E-commerce ─────────────────────────
  'riot-games', 'bungie', 'respawn', 'naughty-dog', 'insomniac',
  'epic-games', 'unity-technologies', 'roblox', 'niantic',
  'kabam', 'jam-city', 'scopely', 'big-fish', 'glu-mobile',
  ...
  'boston-dynamics', 'agility-robotics', 'clearpath', 'universal-robots',
  'shopify-dev', 'bigcommerce', 'nacelle', 'fabric-commerce',
  'constructor-io', 'algolia-search', 'coveo', 'bloomreach',
  'bazaarvoice', 'yotpo', 'okendo', 'stamped-io', 'judge-me',
  'attentive-mobile', 'klaviyo-email', 'drip', 'omnisend', 'sendlane',
  'postscript', 'smartrr', 'recharge', 'stay-ai', 'skio',
  'loop-subscriptions', 'ordergroove', 'bold-commerce',
  'rebuy-engine', 'frequently-bought', 'searchpie', 'monk',
  'gorgias-support', 'richpanel', 'gladly-cx', 'tidio-chat',
  'crisp-chat', 'intercom-cx', 'front-cx', 'helpscout-cx',
  'hiver', 'freshdesk-cx', 'zendesk-cx', 're-amaze', 'kustomer-cx',
  // Media & Journalism
  'the-guardian', 'the-intercept', 'propublica', 'vox', 'vox-media',
  'buzzfeed-news', 'huffpost', 'daily-beast', 'vice-media',
  'axios', 'politico', 'the-hill', 'national-journal',
  'the-atlantic', 'new-yorker', 'vanity-fair', 'wired',
  'techcrunch', 'the-verge', 'engadget', 'gizmodo', 'kotaku',
  'ars-technica', 'vice-motherboard', 'mit-technology-review',
  'ieee-spectrum', 'hacker-news', 'slashdot', 'phoronix',
  'anandtech', 'toms-hardware', 'linus-tech', 'digital-trends',
  'cnet', 'pcmag', 'techradar', 'zdnet', 'infoworld',
  'computerworld', 'macworld', 'idownloadblog', '9to5mac',
  // Nonprofits / NGO
  'ford-foundation', 'macarthur-foundation', 'rockefeller-foundation',
  'bill-melinda-gates', 'wellcome-trust', 'wellcome-sanger',
  'chan-zuckerberg', 'bezos-earth', 'bloomberg-philanthropies',
  'hewlett-foundation', 'packard-foundation', 'carnegie-corp',
  'annie-casey', 'robert-wood-johnson', 'kellogg-foundation',
  'lumina-foundation', 'bill-and-melinda', 'simons-foundation',
  'arnold-ventures', 'schmidt-futures', 'open-philanthropy',
...
export async function fetchAllLeverJobs(): Promise<ScrapedJob[]> {
  ...
  const boards = Array.from(new Set([
    ...(envBoards.length > 0 ? envBoards : DEFAULT_LEVER_BOARDS),
    ...getDiscoveredCompanySlugs('lever'),
  ]));
