...
import { CACHE_DB_FILE, deleteLocationLatLonCacheRow, readAllLocationLatLonCacheRows, upsertLocationLatLonCacheRow, } from '../database/CacheDatabase.js';
import { recordDatabaseRead, recordDatabaseWrite, recordHybridCacheFlow, registerDatabasePath, } from './CacheIoTelemetry.js';
...
const dirtyLocationKeys = new Set();
export function normalizeLocationName(placeName) {
...
async function loadCacheFromDisk() {
    ...
    try {
        ...
        const value = JSON.parse(decodeLegacyCachePayload(raw));
